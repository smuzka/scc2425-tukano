...
import tukano.impl.SQLImpl.JavaShortsForSQL;

import java.util.List;

@Singleton
public class RestShortsResourceForSQL extends RestResource implements RestShorts {

	static final Shorts impl = JavaShortsForSQL.getInstance();
